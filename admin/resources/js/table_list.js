...
var tableFlex = {
    ...
    firstCheckHtml: '<div class="hd_item" style="width:40px;"><div><input type="checkbox" name="name" value="no"></div></div>',
    motivTblWidth: 0,
    leftWidth: 0,
    rightWidth: 0,
    ...
    lookTableHead: (data) => {
        ...
        leftHtml += data.checkedSta ? tableFlex.firstCheckHtml : '';//맨 첫째 체크 박스
        rightHtml += tableFlex.returnRowHtml(tableFlex.rightWidth);
        $.each(obj, (name, cont, sdf) => {
